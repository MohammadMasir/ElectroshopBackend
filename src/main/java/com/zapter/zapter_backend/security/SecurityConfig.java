        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                ...
                                .requestMatchers("/electroshop/").permitAll()
                                .requestMatchers("/electroshop/products").permitAll()
                                .requestMatchers("/electroshop/products/**").permitAll()
                                .requestMatchers("/electroshop/employee/**").permitAll()
                                .requestMatchers("/electroshop/signup").permitAll()
                                .requestMatchers("/electroshop/login").permitAll()
                                .requestMatchers("/electroshop/emp-admin-register").permitAll()
